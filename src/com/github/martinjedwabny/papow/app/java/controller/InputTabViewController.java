...
import com.github.martinjedwabny.papow.app.java.util.EditCell;
import com.github.martinjedwabny.papow.app.java.util.JFXTreeTableViewUtils;
import com.github.martinjedwabny.papow.app.java.viewModel.InputAlternativeViewModel;
...
public class InputTabViewController implements Initializable {
	...
	private void showVoteEditDialog(Voter voter) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/github/martinjedwabny/papow/app/fxml/VoterEditView.fxml"));
	...
	private void showQuestionEditDialog(Question question) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/github/martinjedwabny/papow/app/fxml/QuestionEditView.fxml"));
			StackPane content = loader.load();
